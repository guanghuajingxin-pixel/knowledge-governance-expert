...
const activeTab = ref<'doc' | 'faq'>('doc')
// 问答库页懒加载，切到该页签时才挂载
...
<template>
  <div class="kl-page">
    <el-tabs v-model="activeTab" class="kl-tabs">
      <!-- 页签一：文档库（RAGFlow / DIFY 镜像登记） -->
      <el-tab-pane label="文档库" name="doc">
    ...
    <div class="kl-content">
      ...
      <!-- 页签二：问答库（仅 kb_type=FAQ，问答对维护 + 批量导入 + FAQ 检索） -->
      <el-tab-pane label="问答库" name="faq" lazy>
        <FaqLibrary />
      </el-tab-pane>
    </el-tabs>
